...
def evaluate(t, evaluation_episode_counter, evaluation_episode_time,
    ...
    ax4.plot('x', 'y', data=df_evaluation_reward_jerry, marker='.', linestyle='-', color="springgreen", alpha=0.8,
             label="reward jerry")
    ax4.plot('x', 'y', data=df_evaluation_reward_roadrunner, marker='.', linestyle='-', color="cyan", alpha=0.8,
             label="reward roadrunner")
    ax4.plot('x', 'y', data=df_evaluation_reward_coyote, marker='.', linestyle='-', color="greenyellow", alpha=0.8,
             label="reward coyote")
    plt.grid(True)
    plt.legend(loc='best')
